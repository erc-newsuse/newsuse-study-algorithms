...
```{python}
# Descriptive statistics and distributional plots for the processed dataset.
# Python-only notebook -- no R/emmeans statistical inference.
import importlib
...
data = (
    dataset
    .groupby(["quality", "country", "name"], observed=True)
    .size()
